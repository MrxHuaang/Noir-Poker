    ...
    >
      ...
      <div className="flex flex-col flex-1 gap-1">
        <input
          ...
          maxLength={32}
          className={`px-4 py-2 rounded-full bg-black/30 ring-1 text-zinc-100 placeholder:text-zinc-500 outline-none ${error ? "ring-rose-400/60 focus:ring-rose-400/80" : "ring-white/10 focus:ring-accent-500/40"}`}
        />
        {error && (
      ...
      <div className="flex items-center gap-2">
        <button
          type="submit"
          className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-accent-700/70 hover:bg-accent-600/75 text-accent-100 font-medium text-sm transition"
        >
